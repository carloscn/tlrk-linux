...
static int yt8521_config_init(struct phy_device *phydev)
{
	...
	phy_write(phydev, YT8521SH_EXT_REG_ADDR_OFFSET_REG,
		YT8521SH_EXT_MDIO_CFG_AND_RGMII_OOB_MON);
	msleep(50);
...
static struct mdio_device_id __maybe_unused motorcomm_tbl[] = {
	...
	{ .phy_id = (0x00000128), .phy_id_mask = GENMASK(31, 0) },
	{ .phy_id = (0x0000011a), .phy_id_mask = GENMASK(31, 0) },
	{ }
};
